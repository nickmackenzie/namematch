...
function NavBar(props) {
  ...
  return (
    <section
      id="bottom-navigation sticky"
      class="block card m-2 sticky inset-x-0 bottom-0 z-10 bg-white shadow navbar  m-6 shadow-lg bg-base-100 text-base-content rounded-box"
    >
